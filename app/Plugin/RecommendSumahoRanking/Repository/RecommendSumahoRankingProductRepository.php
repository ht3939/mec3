...
namespace Plugin\RecommendSumahoRanking\Repository;
...
/**
 * RecommendSumahoRankingProductRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class RecommendSumahoRankingProductRepository extends EntityRepository
{
    ...
    public function getMaxRank()
    {
        ...
        $sql = "SELECT MAX(m.rank) AS max_rank FROM Plugin\RecommendSumahoRanking\Entity\RecommendSumahoRankingProduct m";
    ...
    public function getRecommendSumahoRankingProduct(Disp $Disp)
    {
