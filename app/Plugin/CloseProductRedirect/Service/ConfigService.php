...
*/
namespace Plugin\CloseProductRedirect\Service;
...
class ConfigService
{
    ...
    {
        $this->app = $app;
        $this->const = $this->app['config']['CloseProductRedirect']['const'];
    ...
    public function getSubData()
    {
        ...
        /* @var $CprPlugin \Plugin\CloseProductRedirect\Repository\CprPluginRepository */
    ...
    function registerSubData($formData)
    {
        ...
        /* @var $CprPlugin \Plugin\CloseProductRedirect\Entity\CprPlugin */
