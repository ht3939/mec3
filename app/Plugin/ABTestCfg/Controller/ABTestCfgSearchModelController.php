...
namespace Plugin\ABTestCfg\Controller;
...
class ABTestCfgSearchModelController
{
    ...
    public function searchProduct(Application $app, Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            ...
            return $app->render('ABTestCfg/Resource/template/admin/search_product.twig', array(
                'forms' => $forms,
                'Products' => $Products,
            ));
        }
