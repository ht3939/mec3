...
namespace Plugin\ABTestCfg\Repository;
...
/**
 * ABTestCfgProductRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class ABTestCfgProductRepository extends EntityRepository
{
    ...
    public function getMaxRank()
    {
        ...
        $sql = "SELECT MAX(m.rank) AS max_rank FROM Plugin\ABTestCfg\Entity\ABTestCfgProduct m";
    ...
    public function getABTestCfgProduct(Disp $Disp)
    {
