...
namespace Plugin\HSDSameCategory;
...
class PluginManager extends AbstractPluginManager
{
    ...
    const BLOCKNAME = "同じカテゴリの商品を自動で表示";
    const BLOCKFILENAME = "hsd_same_category";
    private $block;
    ...
    private function copyBlock($app)
    {
        ...
        // js, cssのコピー
        $file->copy($app['config']['plugin_realdir'] . '/HSDSameCategory/Resource/template/default/js/hsd_swiper.min.css', $app['config']['template_default_html_realdir'] . '/css/hsd_swiper.min.css');
        $file->copy($app['config']['plugin_realdir'] . '/HSDSameCategory/Resource/template/default/js/hsd_swiper.min.js', $app['config']['template_default_html_realdir'] . '/js/hsd_swiper.min.js');
    ...
    private function removeBlock($app)
    {
        ...
        // js, css を削除
        $file->remove($app['config']['template_default_html_realdir'] . '/css/hsd_swiper.min.css');
        $file->remove($app['config']['template_default_html_realdir'] . '/js/hsd_swiper.min.js');
