...
namespace Plugin\FdRoute\Repository;
...
/**
 * FdRouteProductRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class FdRouteProductRepository extends EntityRepository
{
    ...
    public function getMaxRank()
    {
        ...
        $sql = "SELECT MAX(m.rank) AS max_rank FROM Plugin\FdRoute\Entity\FdRouteProduct m";
    ...
    public function getFdRouteProduct(Disp $Disp)
    {
