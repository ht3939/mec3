...
namespace Plugin\ExcludeProductPayment\Controller\Admin\Plugin;
    ...
    public function edit(Application $app, Request $request)
    {
        ...
        if ('POST' === $this->app['request']->getMethod()) {
            ...
            if ($form->isValid()) {
                ...
                return $this->app->redirect($this->app['url_generator']->generate('plugin_ExcludeProductPayment_config'));
            }
        }

        return $this->app['view']->render('ExcludeProductPayment/Resource/template/admin/Plugin/config.twig',
            array(
