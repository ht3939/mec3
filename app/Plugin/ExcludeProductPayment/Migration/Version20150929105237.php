...
class Version20150929105237 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->createDtbEppPlugin($schema);
        $this->createDtbExcludeProductPayment($schema);
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $schema->dropTable('plg_epp_plugin');
        $schema->dropTable('plg_exclude_product_payment');
    ...
    public function postUp(Schema $schema)
    {
        ...
        $app->boot();
        $pluginCode = 'ExcludeProductPayment';
        $pluginName = '商品別支払方法制限';
        $datetime = date('Y-m-d H:i:s');
        $insert = "INSERT INTO plg_epp_plugin(
    ...
    protected function createDtbEppPlugin(Schema $schema)
    {
        $table = $schema->createTable("plg_epp_plugin");
    ...
    protected function createDtbExcludeProductPayment(Schema $schema)
    {
        $table = $schema->createTable("plg_exclude_product_payment");
