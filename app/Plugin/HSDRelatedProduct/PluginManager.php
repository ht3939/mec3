...
class PluginManager extends AbstractPluginManager
{
    ...
    private function copyBlock($app)
    {
        ...
        // js, cssのコピー
        $file->copy($app['config']['plugin_realdir'] . '/HSDRelatedProduct/Resource/template/default/js/hsd_swiper.min.css', $app['config']['template_default_html_realdir'] . '/css/hsd_swiper.min.css');
        $file->copy($app['config']['plugin_realdir'] . '/HSDRelatedProduct/Resource/template/default/js/hsd_swiper.min.js', $app['config']['template_default_html_realdir'] . '/js/hsd_swiper.min.js');
