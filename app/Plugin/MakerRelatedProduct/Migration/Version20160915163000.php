...
class Version20160915163000 extends AbstractMigration
{
    ...
    {
        $schema->dropTable('plg_maker_related_product');
        $schema->dropTable('plg_maker_related_product_setting');
    }
    ...
    protected function createPluginTable(Schema $schema)
    {
        // データ保存用
        $this->addSql('
            CREATE TABLE plg_maker_related_product (
        ...
        // セッティング
        $this->addSql('
            CREATE TABLE plg_maker_related_product_setting (
              id varchar(32) NOT NULL,
