...
namespace Plugin\RecommendSimRanking\Repository;
...
/**
 * RecommendSimRankingProductRepository
 *
 * This class was generated by the Doctrine ORM. Add your own custom
 * repository methods below.
 */
class RecommendSimRankingProductRepository extends EntityRepository
{
    ...
    public function getMaxRank()
    {
        ...
        $sql = "SELECT MAX(m.rank) AS max_rank FROM Plugin\RecommendSimRanking\Entity\RecommendSimRankingProduct m";
    ...
    public function getRecommendSimRankingProduct(Disp $Disp)
    {
