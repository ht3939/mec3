...
class CustomUrlUserPageSearchModelController
{
     ...
     */
    public function searchUserPage(Application $app, Request $request)
    {
        if ($request->isXmlHttpRequest()) {
            ...
            return $app->render('CustomUrlUserPage/Resource/template/admin/search_product.twig', array(
                'forms' => $forms,
                'Products' => $Products,
            ));
        }
