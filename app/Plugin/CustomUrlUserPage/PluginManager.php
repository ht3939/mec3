...
namespace Plugin\CustomUrlUserPage;
...
class PluginManager extends AbstractPluginManager
{
     ...
     */
    private $originBlock1;
    private $originBlock2;
    private $originBlock;

    /**
     * @var string ブロック名
     */
    private $blockName1 = 'キャンペーン表示ブロック';
    private $blockName2 = 'オプション表示ブロック';
    private $blockName;

    /**
     * @var string ブロックファイル名
     */
    private $blockFileName1 = 'customurl_userpage_campaign_block';
    private $blockFileName2 = 'customurl_userpage_options_block';
    private $blockFileName;

    public function __construct()
    {
        // コピー元ブロックファイル
        $this->originBlock1 = __DIR__ . '/Resource/template/Block/' . $this->blockFileName1 . '.twig';
        $this->originBlock2 = __DIR__ . '/Resource/template/Block/' . $this->blockFileName2 . '.twig';
    }
    ...
    public function enable($config, $app)
    {
        ...
        $this->originBlock = $this->originBlock1;
        $this->blockName = $this->blockName1;
        $this->blockFileName = $this->blockFileName1;
        // ブロックへ登録
        $this->copyBlock($app);

        $this->originBlock = $this->originBlock2;
        $this->blockName = $this->blockName2;
        $this->blockFileName = $this->blockFileName2;
        // ブロックへ登録
        $this->copyBlock($app);
    ...
    private function addPages($app){
        ...
        $this->createPage($app,'campaign_index','Campaign/index','キャンペーンについて');
        $this->createPage($app,'options_index','Options/index','オプションについて');
        /*
