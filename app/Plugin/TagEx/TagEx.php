...
class TagEx
{
    ...
    public function onAdminProductIndexTwig(TemplateEvent $event)
    {
        ...
        $insert  = '<li id="result_list__tag_menu" class="dropdown">';
        $insert .= '<a class="dropdown-toggle" data-toggle="dropdown">タグ一括設定<svg class="cb cb-angle-down icon_down"><use xlink:href="#cb-angle-down"></svg></a>';
        $insert .= '<ul class="dropdown-menu">';
        $insert .= '<li><a href="#" data-toggle="modal" onclick="tagexModalShow(1); return false;">一括変更</a></li>';
        $insert .= '<li><a href="#" data-toggle="modal" onclick="tagexModalShow(2); return false;">一括追加</a></li>';
        $insert .= '<li><a href="#" data-toggle="modal" onclick="tagexModalShow(3); return false;">一括削除</a></li>';
        $insert .= '</ul>';
        $insert .= '</li>';
        $TwigRenderService->twigInsert($search, $insert, 10);
        ...
        $view = 'TagEx/Resource/template/admin/Product/tagex_update_js.twig';
        ...
        if($endBlock == "") {
            ...
            // modal なし
            $search = '{% endblock %}';
            $view = 'TagEx/Resource/template/admin/Product/tagex_update.twig';
