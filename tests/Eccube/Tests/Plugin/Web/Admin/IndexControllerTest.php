...
class IndexControllerTest extends AbstractAdminWebTestCase
{
    ...
    public function testRoutingAdminIndex()
    {
        ...
        $hookpoins = array(
            EccubeEvents::ADMIN_ADMIM_INDEX_INITIALIZE,
            EccubeEvents::ADMIN_ADMIM_INDEX_ORDER,
            EccubeEvents::ADMIN_ADMIM_INDEX_SALES,
            EccubeEvents::ADMIN_ADMIM_INDEX_COMPLETE,
        );
