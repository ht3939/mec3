...
class CreateEcCubeData
{
    ...
    /** 規格名 */
    var $arrClassName = array();

    /** 商品一覧 */
    var $arrProduct = array();

    /** 規格1 */
    var $arrClassCategory1 = array();

    /** 規格2 */
    var $arrClassCategory2 = array();
    ...
    function createClassData()
    {
        ...
        $existingClassNameMaxRank = $q->getSingleResult()[1];
        ...
        $existingClassCategoryMaxRank = $q->getSingleResult()[1];
     ...
     * @return void
     */
    function createClassName($class_name, $rank)
    {
